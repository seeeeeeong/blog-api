...
class PostRepositoryCustomImpl(
    ...
    override fun searchByKeyword(query: String, categoryId: Long?, pageable: Pageable): Page<PostEntity> {
        ...
        val dataQuery = entityManager.createQuery(jpql, PostEntity::class.java)
