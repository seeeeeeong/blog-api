...
class ImageServiceTest {
    ...
    fun `gif content type 으로 presigned url 을 생성할 수 있다`() {
        ...
        `when`(
            s3Presigner.presignPutObject(any(PutObjectPresignRequest::class.java)),
    ...
    private fun fixture(s3Presigner: S3Presigner = mock(S3Presigner::class.java)): ImageService =
        ImageService(
